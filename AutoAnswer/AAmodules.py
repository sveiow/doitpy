...
class KMY():
    ...
    BoxBlank = '674D6AEA2013C3019B9B6B02E32D647B'          #删除Q2box空白图片的KEY
...
class LXC():
    ...
    Pwebdelay = 'A3E341FF8DB62564DB1A9D3824BAD709'       #解决网站卡，引发不会下一节的死循环
    Bwebdelay = '1C4BA854629420EEB73547724C71E9DF'
