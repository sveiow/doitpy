#coding=utf-8
#Introduction:單小節收集-----for:闯关王——练兵场,正式可用,20140819
#version:Pickit_a4.0
#updata a4.0:基于a3.5修改字典部分，修改Q2BOX，修改TIPSBOS，修改TIPSMD5
#updata a3.5:修改鼠標模擬的方式，解決鼠標失控問題（側面解決死循環）
...
def wdict(dictfile,dic):
    if os.path.isfile(dictfile):            #檢測字典是否已經存在
