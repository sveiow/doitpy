...
Pcbox = (620,760,690,785)           #進度條

imageQ = fullsc.crop(Qbox).save(wokingp + 'imageQ.jpg','JPEG')         #截图，保存
...
if Tipsmd5 == Amd5:
    imageA = fullsc.crop(Abox).save(wokingp + 'imageA.jpg','JPEG')
    ...
    imageB = fullsc.crop(Bbox).save(wokingp + 'imageB.jpg','JPEG')
    ...
    imageC = fullsc.crop(Cbox).save(wokingp + 'imageC.jpg','JPEG')
    ...
    imageD = fullsc.crop(Dbox).save(wokingp + 'imageD.jpg','JPEG')
    ...
    #判斷當前進度
Process = fullsc.crop(Pcbox).save(wokingp + 'Process.jpg','JPEG')         #截图，保存
PcQ = open(wokingp +'Process.jpg','rb')
Pmd5 = hashlib.md5(PcQ.read()).hexdigest() 
