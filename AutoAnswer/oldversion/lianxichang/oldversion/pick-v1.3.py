#coding=utf-8
#version:1.3，版本倒退，缺题目校验，缺追加模式，当前没问题
...
if os.path.isfile('hashdict.pkl'):
    oldict = open('hashdict.pkl', 'rb')            ##此处需要添加判断语句！！！！！
    oldata = pickle.load(oldict)                    ##toongshang
else:
...
def pickit():
    ...
    def md5w():
        ...
        wmd5 = '%s' % md5
        hashdict[wQmd5] = wmd5
##        output = open('hashdict.pkl', 'a+b')         #写入文件
